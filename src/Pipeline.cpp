...
PipelineConfig Pipeline::getDefaultPipelineConfigInfo(uint32_t width, uint32_t height) {
...
void Pipeline::createGraphicsPipeline(const std::string& vertShaderPath, const std::string& fragShaderPath,
    ...
    viewportCreateInfo.pViewports = &config.viewport;
    viewportCreateInfo.scissorCount = 1;
    viewportCreateInfo.pScissors = &config.scissor;
